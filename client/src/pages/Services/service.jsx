    ...
    <header className="relative w-full overflow-hidden bg-[#8B0D7A]">
      ...
      >
        ...
        <p className="text-white/90 text-base sm:text-lg max-w-2xl leading-relaxed">
          We provide a wide range of technology-driven services, from web development
          and digital solutions to IT consulting, designed to help your business thrive.
        </p>
      </div>
    </header>
